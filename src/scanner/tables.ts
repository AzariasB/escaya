...
export const oneCharTokens = [
  ...
  /*  97 - a                  */ Token.MaybeKeyword,
  /*  98 - b                  */ Token.MaybeKeyword,
  /*  99 - c                  */ Token.MaybeKeyword,
  /* 100 - d                  */ Token.MaybeKeyword,
  /* 101 - e                  */ Token.MaybeKeyword,
  /* 102 - f                  */ Token.MaybeKeyword,
  /* 103 - g                  */ Token.MaybeKeyword,
  /* 104 - h                  */ Token.Identifier,
  /* 105 - i                  */ Token.MaybeKeyword,
  /* 106 - j                  */ Token.Identifier,
  /* 107 - k                  */ Token.Identifier,
  /* 108 - l                  */ Token.MaybeKeyword,
  /* 109 - m                  */ Token.MaybeKeyword,
  /* 110 - n                  */ Token.MaybeKeyword,
  /* 111 - o                  */ Token.MaybeKeyword,
  /* 112 - p                  */ Token.MaybeKeyword,
  /* 113 - q                  */ Token.Identifier,
  /* 114 - r                  */ Token.MaybeKeyword,
  /* 115 - s                  */ Token.MaybeKeyword,
  /* 116 - t                  */ Token.MaybeKeyword,
  /* 117 - u                  */ Token.MaybeKeyword,
  /* 118 - v                  */ Token.MaybeKeyword,
  /* 119 - w                  */ Token.MaybeKeyword,
  /* 120 - x                  */ Token.Identifier,
  /* 121 - y                  */ Token.MaybeKeyword,
