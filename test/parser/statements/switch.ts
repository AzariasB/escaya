...
describe('Statements - Switch', () => {
  ...
  for (const arg of [
    ...
    'switch(0) { case 0: let a; case 1: function a(){} }',
    'switch(0) { case 0: let a; default: let a; }',
    'switch(0) { default: let a; case 0: let a; }',
    'switch(0) { default: let a; case 0: function a(){} }',
    'switch(0) { default: function a(){} case 0: let a  }',
    ...
    'switch (0) { case 1: var f; default: function* f() {} }',
    'switch (0) { case 1: var f = 0; ({f}) default: let x; }',
    'switch (0) { case 1: var f = 0; const {f} = x; default: let x; }',
