...
describe('Statements - For await of', () => {
  ...
  for (const arg of [
    ...
    'async function f() { for await (let [...[x], y] of (async function*() { yield* [[1, 2, 3]]; })()) {} }',
    'async function f() { for await (let [a = 1, ...b] = 1 of []); }',
  ...
  for (const arg of [
    ...
    'async function f() { for\nawait ({"a": a} of []) { } }',
    'async function f() { for\nawait ({[Symbol.iterator]: a} of []) { } }',
    'async function f() { for await ([ x = "x" in {} ] of [[]]) {} }',
    'async function f() { for await ([ x = yield ] of [[]]) {} }',
    'async function f() { for await ([ c ] of [[1]]) { } }',
    'async function f() { for await ([x, y, z] of [[1, 2, 3]]) { } }',
    'async function f() { for await ([, , x, , ...y] of [[1, 2, 3, 4, 5, 6]]) { } }',
    'async function f() { for await ({} of [{}]) { } }',
    'async function f() { for await ({ arrow = () => {} } of [{}]) { } }',
    'async function f() { for await ({ a = x += 1, b = x *= 2 } of [{}]) { } }',
    'async function f() { for await ({...rest} of [Symbol("foo")]) { } }',
    'async function f() { for await (const [[...x] = [2, 1, 3]] of [[]]) { } }',
    'async function f() { for await ([, , x, , ...y] of [[1, 2, 3, 4, 5, 6]]) { } }',
    'async function f() { for await ({} of [0]) { } }',
    'async function f() { for await ({ arrow = () => {} } of [{}]) {} }',
    'async function f() { for await ({ y: x = 1 } of [{ y: null }]) { } }',
    'async function f() { for await ({ x: prop = "x" in {} } of [{}]) {} }',
    'async function f() { for await ({...{}.y} of [{ x: 1, y: 2}]) {} }',
    'async function f() { for await (const [x = 23] of (async function*() { yield* [[,]]; })()) {} }',
    'async function f() { for await (const {} of [null]) { } }',
    'async function f() { for await (let [{ x }] of [[null]]) {} }',
    'async function f() { for await ([...[x]] of [[1, 2, 3]]) {} }',
    'async function f() { for await ([...{ 1: x }] of [[1, 2, 3]]) { } }',
    'async function f() { for await ({} of [false]) { } }',
    'async function f() { for await ({ xCls = class x {}, cls = class {}, xCls2 = class { static name() {} } } of [{}]) {} }',
    'async function f() { for await ({ x: xCls = class x {}, x: cls = class {}, x: xCls2 = class { static name() {} } } of [{}]) {} }',
    'async function f() { for await ({ x: { y } } of [{ x: { y: 2 } }]) {} }',
    'async function f() { for await ({ x: y } of [{}]) {} }',
    'async function f() { for await (const [x = 23] of [[,]]) { } }',
    'async function f() { for await (var { w: [x, y, z] = [4, 5, 6] } of (async function*() { yield* [{ w: [7, undefined, ] }]; })()) {} }',
    'async function f() { for await (var {...x} of [{ get v() { count++; return 2; } }]) {} }',
    'async function f() { for await ([, , x, , ...y] of [[1, 2, 3, 4, 5, 6]]) { } }',
    'async function f() { for await ({...x} of [{ get v() { count++; return 2; } }]) { } }',
    'async function f() { for await (const [{ x, y, z } = { x: 44, y: 55, z: 66 }] of (async function*() { yield* [[{ x: 11, y: 22, z: 33 }]]; })()) {} }',
    'async function f() { for await (let [...x] of [[1, 2, 3]]) {} }',
    'async function f() { for\nawait ({0: a} of []) { } }',
    'async function f() { for\nawait ({a = 1} of []) ; }',
    'async function f() { for\nawait ({a: a = 1} of []) ; }',
    'async function f() { for\nawait ({[Symbol.iterator]: a = 1} of []) ; }',
