...
describe('Declarations - Async Function', () => {
  ...
  for (const arg of [
    ...
    'async function f(){ for await(a of b) label: function f(){} }',
    'async function f(){ for await(var a of b) label: function f(){} }',
    'async function f(){ for await(let a of b) label: function f(){} }',
    'async function f(){ for await(const a of b) label: function f(){} }',
  ...
  for (const arg of [
    ...
    `async function fn() {(await x).a = y; }`,
    'async function f(){ for await (let x of 0) { break; } }',
    'async function f(){ for await (let x of 0) { continue; } }',
