...
describe('Declarations - Var', () => {
  ...
  for (const arg of [
    ...
    'var a, b; ([a, b]) = [1, 2];',
    'var a, b; ({a, b}) = { a: 1, b: 2 };',
    'var a, b; [(repair.man = 17)] = [1];',
    'var a, b; [(demolition["man"] = "motel")] = [1, 2];',
    'var a, b; var obj = { x() { [(super.man = 5)] = [1]; } };',
    'var a, b; var obj = { x() { [(super[8] = "motel")] = [1]; } };',
    'var a, b; [(f()) = "kthxbai", b] = [1, 2];',
    'var [a, ...rest, b] = c;',
    'var [a a, b] = c;',
    'var {...x = 1} = {}',
    'var {...[]} = {}',
  ...
  for (const arg of [
    ...
    'var a = [1], i = 0; [a[i++]] = [];',
    'var [,] = [];',
    'var a, b; ({ a: (a), b} = { a: 1, b: 2 });',
    'var a, b; var obj = { x() { [(super.man), b] = [1, 2]; } };',
    'var a, b; var obj = { x() { [(super[8]) = "motel", b] = [1, 2]; } };',
    'var a, b; [(a), b] = [1, 2];',
    'var a, b; [(a) = 5, b] = [1, 2];',
    'var a, b; [(arguments) = 5, b] = [1, 2];',
    'var a, b; [(eval) = 5, b] = [1, 2];',
    'var a, b; [(eval), b] = [1, 2];',
    'var [a,] = [];',
    'var a; [a,] = [];',
    'var [a,,b] = [];',
