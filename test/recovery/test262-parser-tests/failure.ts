...
describe('test262-parser-tests - failing tests', () => {
  it(',,,,,,let x, y, ;', () => {
    t.deepStrictEqual(recovery(',,,,,,let x, y, ;', 'recovery.js'), {
      children: [],
      context: 0,
      detached: false,
      diagnostics: [
  ...
  it('import * as enum from "foo"', () => {
    t.deepStrictEqual(recovery('import * as enum from "foo"', 'recovery.js', { module: true }), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('/42', () => {
    t.deepStrictEqual(recovery('/42', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('function null() { }', () => {
    t.deepStrictEqual(recovery('function null() { }', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('[{a=0},...0]', () => {
    t.deepStrictEqual(recovery('[{a=0},...0]', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('function x(...a = 1){}', () => {
    t.deepStrictEqual(recovery('function x(...a = 1){}', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('function *g() { function yield() {} }', () => {
    t.deepStrictEqual(recovery('function *g() { function yield() {} }', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('new.prop', () => {
    t.deepStrictEqual(recovery('new.prop', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('foo[/42', () => {
    t.deepStrictEqual(recovery('foo[/42', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('yield v', () => {
    t.deepStrictEqual(recovery('yield v', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('for (let let;;;) {}', () => {
    t.deepStrictEqual(recovery('for (let let;;;) {}', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('(10) => 0', () => {
    t.deepStrictEqual(recovery('(10) => 0', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('for (let x = 42 in list) process(x);', () => {
    t.deepStrictEqual(recovery('for (let x = 42 in list) process(x);', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('({a({e: a.b}){}})', () => {
    t.deepStrictEqual(recovery('({a({e: a.b}){}})', 'recovery.js'), {
      directives: [],
      leafs: [
        {
          type: 'ExpressionStatement',
  ...
  it('var [a.b] = 0', () => {
    t.deepStrictEqual(recovery('var [a.b] = 0', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('(function *(x, ...yield){})', () => {
    t.deepStrictEqual(recovery('(function *(x, ...yield){})', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('"\\u{FFFF"', () => {
    t.deepStrictEqual(recovery('"\\u{FFFF"', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [
        {
  ...
  it('\\ua', () => {
    t.deepStrictEqual(recovery('\\ua', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('0b12', () => {
    t.deepStrictEqual(recovery('0b12', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('var _𖫵 = 11;', () => {
    t.deepStrictEqual(recovery('var _𖫵 = 11;', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('\\o', () => {
    t.deepStrictEqual(recovery('\\o', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('"use strict"; for (let [a = let];;) {}', () => {
    t.deepStrictEqual(recovery('"use strict"; for (let [a = let];;) {}', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [
        {
  ...
  it('(function() { yield 3; })', () => {
    t.deepStrictEqual(recovery('(function() { yield 3; })', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('({a:b[0]})=>0', () => {
    t.deepStrictEqual(recovery('({a:b[0]})=>0', 'recovery.js'), {
      directives: [],
      leafs: [
        {
          type: 'ExpressionStatement',
  ...
  it('with(true) let a', () => {
    t.deepStrictEqual(recovery('with(true) let a', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('({ set prop() {} })', () => {
    t.deepStrictEqual(recovery('({ set prop() {} })', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('a: let a', () => {
    t.deepStrictEqual(recovery('a: let a', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('for (let x, y, z, let;;;) {}', () => {
    t.deepStrictEqual(recovery('for (let x, y, z, let;;;) {}', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('for ((i in {}));', () => {
    t.deepStrictEqual(recovery('for ((i in {}));', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('const const;', () => {
    t.deepStrictEqual(recovery('const const;', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('for(var a = 0 of b);', () => {
    t.deepStrictEqual(recovery('for(var a = 0 of b);', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('for(let[a].b of 0);', () => {
    t.deepStrictEqual(recovery('for(let[a].b of 0);', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('function f(a, ...b, c){}', () => {
    t.deepStrictEqual(recovery('function f(a, ...b, c){}', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('for (const x = 1 of y);', () => {
    t.deepStrictEqual(recovery('for (const x = 1 of y);', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('for(;;) function a(){}', () => {
    t.deepStrictEqual(recovery('for(;;) function a(){}', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('var this = 10;', () => {
    t.deepStrictEqual(recovery('var this = 10;', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('function *g() { try {} catch (yield) {} }', () => {
    t.deepStrictEqual(recovery('function *g() { try {} catch (yield) {} }', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('for (let x = 42 of list) process(x);', () => {
    t.deepStrictEqual(recovery('for (let x = 42 of list) process(x);', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('"use strict"; ({ v: eval }) = obj', () => {
    t.deepStrictEqual(recovery('"use strict"; ({ v: eval }) = obj', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [
        {
  ...
  it('/{*/u;', () => {
    t.deepStrictEqual(recovery('/{*/u;', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('try { } catch ([a] = []) { }', () => {
    t.deepStrictEqual(recovery('try { } catch ([a] = []) { }', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('[...0,...{a=0}]=0', () => {
    t.deepStrictEqual(recovery('[...0,...{a=0}]=0', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('func() = 4', () => {
    t.deepStrictEqual(recovery('func() = 4', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('0xz', () => {
    t.deepStrictEqual(recovery('0xz', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('for (const x = 1, y = 2, z = 3, let = 0;;;) {}', () => {
    t.deepStrictEqual(recovery('for (const x = 1, y = 2, z = 3, let = 0;;;) {}', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('function false() { }', () => {
    t.deepStrictEqual(recovery('function false() { }', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('obj = {x = 0}', () => {
    t.deepStrictEqual(recovery('obj = {x = 0}', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('a class;', () => {
    t.deepStrictEqual(recovery('a class;', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('function*g() { let yield; }', () => {
    t.deepStrictEqual(recovery('function*g() { let yield; }', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('(function*() { yield* })', () => {
    t.deepStrictEqual(recovery('(function*() { yield* })', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('f(... ... a)', () => {
    t.deepStrictEqual(recovery('f(... ... a)', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('[x] += 0', () => {
    t.deepStrictEqual(recovery('[x] += 0', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
  ...
  it('class A extends B { constructor() { (super)(); } }', () => {
    t.deepStrictEqual(recovery('class A extends B { constructor() { (super)(); } }', 'recovery.js'), {
      type: 'RootNode',
      webCompat: true,
      directives: [],
      leafs: [
